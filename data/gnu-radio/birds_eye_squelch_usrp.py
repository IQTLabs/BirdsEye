...
class birds_eye_squelch_usrp(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Birds Eye Squelch USRP")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Birds Eye Squelch USRP")
        ...
        self.settings = Qt.QSettings("GNU Radio", "birds_eye_squelch_usrp")
        ...
        # Blocks
        ##################################################
        self._threshold_range = Range(-110, 0, .5, -95, 200)
        ...
        self.blocks_head_0 = blocks.head(gr.sizeof_gr_complex*1, 57500000)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/media/oem/data/data/set-4/birds-eye-dji-p3-5745MHz-lp-0m-45gain-off.raw', False)
...
def main(top_block_cls=birds_eye_squelch_usrp, options=None):
