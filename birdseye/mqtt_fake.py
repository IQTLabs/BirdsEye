...
if __name__ == '__main__':
    ...
    def message_handler(data):
        logging.info(
            "Message handler received data: {}".format(data)
        )
    ...
    def on_key_release(key):
        ...
        mqtt_client.client.publish("gamutrf/rssi", json.dumps(publish_data)) # also tried qos = 1 and 2
        logging.info(
            "Started transmission to broker: {}".format(publish_data)
        )
