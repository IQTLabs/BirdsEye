...
def panel_dual_axis(ax1, config, mcts=True, dqn=True, metric1='r_err', metric2='theta_err', variance_bars=False, verbose=False, limit=1, y_lim=125):
    # set strings 
...
def single_plot_var(ax1, config, metric='r', variance_bars=False, verbose=False, limit=1, y_lim=125):
    cov_idx = {'r':0, 'theta':1}
...
def single_plot_combined_cov(ax1, config, mcts=True, dqn=True, metric='centroid_err', variance_bars=False, verbose=False, limit=1, y_lim=125):
    reward_str = {'range_reward':'State Dependent Reward', 'entropy_collision_reward':'Belief Dependent Reward'}
    sensor_str = {'drone':'Bearings Sensor','signalstrength':'Signal Strength Sensor'}
