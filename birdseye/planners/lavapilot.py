...
class LAVAPilot:
    ...
    def get_action(self,):
        ...
        proposals = circ_tangents([0,0], self.env.get_particle_centroids()[object_of_interest], self.r_min)
        ...
        if proposals is not None:
            ...
            for p in proposals:
                ...
                trajectory[:,1] = np.minimum(p[0]/self.horizon, self.env.state.sensor_speed)
