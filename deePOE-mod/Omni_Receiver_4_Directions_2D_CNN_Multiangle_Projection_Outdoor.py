...
print("Total number of i/q samples for 0 deg:", scipy.fromfile(open(data_file_loc1), dtype=dtype_all).shape[0])
#
print("Total number of i/q samples for 45 deg:", scipy.fromfile(open(data_file_loc2), dtype=dtype_all).shape[0])
#
print("Total number of i/q samples for 90:", scipy.fromfile(open(data_file_loc3), dtype=dtype_all).shape[0])
#
print("Total number of i/q samples for 135:", scipy.fromfile(open(data_file_loc4), dtype=dtype_all).shape[0])
...
plt.tight_layout()
fig.savefig('/home/oem/birds-eye2/DeePOE-mod/direction_4_acc_2D_CNN_Mapping_Outdoor.png')  # save the figure to file
plt.close(fig)
...
def plot_confusion_matrix(cm, title='Confusion Matrix', cmap=plt.cm.YlGnBu, labels=[], normalize=False):
    ...
    plt.tight_layout()
    fig.savefig('/home/oem/birds-eye2/DeePOE-mod/direction_4_conf_mat_2D_CNN_Mapping_Outdoor.png')  # save the figure to file
    plt.close(fig)
